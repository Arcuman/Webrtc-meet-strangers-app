...
//register event listeners for connections button
...
personalCodeChatButton.addEventListener("click", () => {
  ...
  const callType = constants.callType.CHAR_PERSONAL_CODE;
...
const strangerVideoBuuton = document.getElementById("stranger_video_button");
strangerVideoBuuton.addEventListener("click", () => {
...
//recording
const startRecordigButton = document.getElementById("start_recording_button");
startRecordigButton.addEventListener("click", () => {
